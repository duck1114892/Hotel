...
const CreatBooking = (prop) => {
    ...
    const hanldeGetTotal = async (e) => {
        ...
        setMaxRoom(getTotal.data.availability)
    }
    ...
    useEffect(() => {
        const getInfo = async () => {
            const getEmail = await getListUser();
                ...
                >
                    ...
                    >
                        <Select
                            ...
                            optionFilterProp="children" availability
                    ...
                    >
                        <InputNumber min={0} max={maxRoom} onChange={(e) => { handleQuantity(e) }} />
                    </Form.Item>
                    <Form.Item
                        label="Ngày Check In"
                        name="checkIn"
